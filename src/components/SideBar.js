...
function SideBar({onChildClick, visible}){
    return(
        <div className='bg-gunMetal'>
            <button id="toggle-sidebar" onClick={onChildClick} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="float-right p-2 mt-2 ml-3 text-sm  rounded-lg min-[639px]:hidden focus:outline-none focus:ring-2">
