...
function SideBar({onChildClick, visible}){
    return(
        <div className='bg-gunMetal'>
            <button id="toggle-sidebar" onClick={onChildClick} data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="absolute right-5 p-2 mt-6 ml-3 text-sm  rounded-lg focus:outline-none focus:ring-2">
