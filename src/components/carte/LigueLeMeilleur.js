...
function LigueLeMeilleur({id,title, img_url, data_name, data_value1, data_value2}){
    return (
        ...
        <div className="text-center">
            <p className="text-lg font-bold font-title">{title}</p>
        ...
        <div className="flex md:max-xl:flex-col sm:max-md:flex-col max-sm:flex-col justify-evenly lg:mx-2 lg:mt-5 md:max-xl:mt-1 sm:max-md:mt-0 max-sm:mt-0">
            ...
            <div className='basis-4/6 text-center'>
                <p className="text-lg font-bold font-content text-tiffanyBlue">{data_name}</p>
                <p className="font-content text-white">{data_value1}</p>   
                <p className="text-xs font-content text-white">({data_value2})</p>   
            </div>
        </div>
        </div>
    )
