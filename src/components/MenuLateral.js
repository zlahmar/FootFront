...
function MenuLateral(){
    return (
        <div className="lg:w-2/12 md:w-1/12 sm:w-1/12 pr-3 pt-3">
            <div className="w-full h-2/6 bg-gunMetal text-center flex justify-center pt-6 rounded-tr-3xl" >
                <h1 className="pr-3 text-tiffanyBlue font-title text-4xl"> FootStat </h1>
                <img className="w-10 h-10" alt="logo" src={logo}  />
            </div>

            <div className="w-full h-4/6 rounded-br-3xl bg-gunMetal">
